...
The lobby stores a full Sunday-to-Saturday schedule and resets every Saturday at 23:59 in `Europe/Amsterdam`. Existing installations should run `switch-to-weekly-reset.sql` once in the Supabase SQL Editor.
